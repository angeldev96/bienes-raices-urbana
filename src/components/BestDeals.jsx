    ...
    return (
        <div className=''>
            <div className='w-11/12 md:w-1/2 xl:w-1/3 m-auto text-center py-10'>
                <h1 className='text-4xl font-bold'>Descubre las Oportunidades Inmobiliarias Imperdibles</h1>
                <p className='text-xs  text-gray-400'>Explora una selección exclusiva de propiedades que te brindarán las mejores opciones para encontrar tu nuevo hogar. Nuestro equipo está aquí para guiarte en cada paso del camino y hacer que tu experiencia sea excepcional.</p>
            </div>
            <div className="deals w-full  grid lg:grid-flow-col grid-row-2  gap-8">
                <div className="deal relative col-span-2 row-span-2">
                    ...
                    <div className='w-full absolute bottom-0 p-4 text-white bg-gradient-to-t from-black rounded-b-xl space-y-2'>
                        <h1 className='text-3xl font-bold'>LUGAR</h1>
                        <p className='flex items-center space-x-2 text-sm'><IoLocationOutline />Kissimmee, Florida, EE. UU.</p>
                    </div>
                </div>
