...
const Hero = () => {
  ...
  <button className="bg-white border border-cyan-900 px-5 py-2 rounded-xl text-xs md:text-base text-cyan-900 hover:bg-gray-200">Iniciar sesión</button>  <button className="bg-cyan-900 px-5 py-2 rounded-xl text-xs md:text-base text-gray-300 hover:bg-cyan-700">Registrarse</button>
  </div>
</nav>
